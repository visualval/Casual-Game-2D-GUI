...
#endif
                        break;
                    case ImageComponent.ShapesAsset:
                        DALogger.LogError(FcuLocKey.log_featutre_at_dev_stage.Localize(value));
                        SetValue(ref imageComponent, ImageComponent.UnityImage);
                        return;
#if FREYA_SHAPES_EXISTS == false
                        DALogger.LogError(FcuLocKey.log_asset_not_imported.Localize(nameof(ImageComponent.ShapesAsset)));
                        SetValue(ref imageComponent, ImageComponent.UnityImage);
                        return;
#endif
                        break;
