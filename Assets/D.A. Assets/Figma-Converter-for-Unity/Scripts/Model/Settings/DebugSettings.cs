...
namespace DA_Assets.FCU.Model
{
    ...
    public class DebugSettings : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        public bool LogComponentDrawer { get => logComponentDrawer; set => SetValue(ref logComponentDrawer, value); }

        [SerializeField] bool logHashGenerator = true;
        public bool LogHashGenerator { get => logHashGenerator; set => SetValue(ref logHashGenerator, value); }
