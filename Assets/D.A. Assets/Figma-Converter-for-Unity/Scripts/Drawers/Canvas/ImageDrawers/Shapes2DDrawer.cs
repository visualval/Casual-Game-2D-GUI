...
namespace DA_Assets.FCU.Drawers.CanvasDrawers
{
    ...
    public class Shapes2DDrawer : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        private void SetColor(FObject fobject, Shape shape)
        {
            ...
            monoBeh.Log($"SetUnityImageColor | {fobject.Data.Hierarchy} | {fobject.Data.FcuImageType} | hasFills: {graphic.HasFill} | hasStroke: {graphic.HasStroke}", FcuLogType.ComponentDrawer);
                            ...
                            if (!gradientColorKeys.IsEmpty())
{
        ...
        private void SetCorners(FObject fobject, Shape shape)
        {
            ...
            else
            {
                ...
                {
                    Vector4 cr = fobject.GetCornerRadius(ImageComponent.SubcShape);
