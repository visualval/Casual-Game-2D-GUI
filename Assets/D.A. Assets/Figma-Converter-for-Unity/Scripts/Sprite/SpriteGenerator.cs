...
namespace DA_Assets.FCU
{
    ...
    public class SpriteGenerator : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        public IEnumerator GenerateSprites(List<FObject> fobjects)
        {
            ...
            {
                monoBeh.Log($"GenerateSprites | {fobject.Data.NameHierarchy} | {fobject.Data.NeedGenerate}");
                ...
                try
                {
                    ...
                    monoBeh.Log($"GenerateSprites | {fobject.Data.NameHierarchy} | hasFills: {graphic.HasFill} | hasStrokes: {graphic.HasStroke}", FcuLogType.Default);
                ...
                {
                    monoBeh.Log($"Can't generate '{fobject.Data.NameHierarchy}'\n{ex}", FcuLogType.Error);
